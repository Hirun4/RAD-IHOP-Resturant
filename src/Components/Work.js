      ...
      <div className="work-section-wrapper">
        <div className="work-section-top">
          ...
          <p className="primary-text common-text">
            ...
            continuously evolved, embracing innovation while preserving our core values of excellence
            and dedication.
          </p>
...
<ul class="values-list">
  ...
  <li>
    <strong>Customer Satisfaction:</strong> We are committed to providing excellent service and delicious food to our customers.
  </li>
  <li>
    <strong>Innovation:</strong> We continually seek new ways to improve our menu and delivery service.
  </li>
  <li>
    <strong>Community:</strong> We value our community and strive to give back whenever possible.
  </li>
  <li>
    <strong>Sustainability:</strong> We are dedicated to sustainable practices, from sourcing ingredients to packaging.
  </li>
</ul>
